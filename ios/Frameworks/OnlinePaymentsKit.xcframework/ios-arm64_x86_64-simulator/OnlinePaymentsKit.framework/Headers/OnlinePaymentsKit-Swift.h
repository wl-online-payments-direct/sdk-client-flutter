...
@property (nonatomic, copy) NSString * _Nonnull locale SWIFT_DEPRECATED_MSG("The 'locale' property is deprecated. Do not use it (no replacement needed).");
...
@property (nonatomic) enum OPValidationType type;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
