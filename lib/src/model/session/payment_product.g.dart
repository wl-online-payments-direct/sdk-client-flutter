...
PaymentProduct _$PaymentProductFromJson(Map<String, dynamic> json) {
  $checkKeys(json, requiredKeys: const ['fields']);
  return PaymentProduct(
    ...
    displayHintsList:
        (json['displayHintsList'] as List<dynamic>?)
            ?.map(
              (e) => PaymentProductDisplayHints.fromJson(
        ...
        const [],
    accountsOnFile:
        (json['accountsOnFile'] as List<dynamic>?)
...
Map<String, dynamic> _$PaymentProductToJson(
  PaymentProduct instance,
) => <String, dynamic>{
  'id': instance.id,
  ...
  'displayHintsList': instance.displayHintsList.map((e) => e.toJson()).toList(),
  'accountsOnFile': instance.accountsOnFile.map((e) => e.toJson()).toList(),
  'paymentProduct302SpecificData': instance.paymentProduct302SpecificData
      ?.toJson(),
  'paymentProduct320SpecificData': instance.paymentProduct320SpecificData
      ?.toJson(),
