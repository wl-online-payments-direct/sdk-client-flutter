...
PaymentRequest _$PaymentRequestFromJson(Map<String, dynamic> json) {
  $checkKeys(json, requiredKeys: const ['paymentProduct', 'tokenize']);
  return PaymentRequest(
      paymentProduct: PaymentProduct.fromJson(
        json['paymentProduct'] as Map<String, dynamic>,
      ),
      tokenize: json['tokenize'] as bool? ?? false,
      accountOnFile: json['accountOnFile'] == null
          ? null
          : AccountOnFile.fromJson(
              json['accountOnFile'] as Map<String, dynamic>,
            ),
    )
...
Map<String, dynamic> _$PaymentRequestToJson(
  ...
  'errorMessageIds': instance.errorMessageIds.map((e) => e.toJson()).toList(),
