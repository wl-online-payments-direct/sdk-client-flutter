...
import 'package:online_payments_sdk/src/listeners/listeners.dart';
import 'package:online_payments_sdk/src/model/models.dart';
import 'package:online_payments_sdk/src/native/bridge/native_communicator_bridge.dart';
import 'package:online_payments_sdk/src/session/session_sdk_interface.dart';
import 'package:online_payments_sdk/src/utils/constants.dart';

/// Session is used to perform Client API requests, such as get Payment Products and get IIN Details.
final class Session {
  final NativeCommunicator _nativeSdkCommunicator = NativeCommunicator(bridge: platformSdkBridge);
  ...
  Future<void> _initNativeSdk() async {
    ...
    final result = await _nativeSdkCommunicator.createSession(sessionRequest).onError((error, stackTrace) {
  ...
  getCurrencyConversionQuote({
    ...
    return _nativeSdkCommunicator.listenForCurrencyConversionQuote(request, listener).awaitJob();
  }
