...
import 'package:online_payments_sdk/src/listeners/api_response_listener_interface.dart';

class NativeFutureInterface<T> {
  ...
  NativeFutureInterface.fromListener(ApiResponseInterface<T> listener) {
    onSuccess = (response) {
