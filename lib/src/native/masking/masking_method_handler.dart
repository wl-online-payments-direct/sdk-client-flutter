...
class _MaskingMethodChannel extends _NativeMaskingInterface {
  ...
  Future<String> maskedValueForAccountOnFile(String maskedValueRequest) async {
    final result = await _maskingChannel.invokeMethod('maskedValueForAccountOnFile', {"request": maskedValueRequest});
    return result;
  }
  ...
  Future<String> customMaskedValueForAccountOnFile(
    ...
    final result =
        await _maskingChannel.invokeMethod('customMaskedValueForAccountOnFile', {"request": customMaskedValueRequest});
    return result;
  }
}
